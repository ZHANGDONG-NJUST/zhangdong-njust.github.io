...
<p align="justify">
My primary research interests have been in Machine Learning, Computer Vision, and Medical Image Analysis, with a focus on some fundamental research tasks such as image classification, semantic segmentation, and object detection. Going forward, my research interests will be centered around the co-design of hardware and software systems, with a focus on developing integrated vision recognition systems that are tailored to downstream applications such as healthcare and wellness analysis. </p>
